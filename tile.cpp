...
Tile::Tile(SDL_Texture* tileset, Vector2 size, Vector2 tilesetPosition, Vector2 position):
	...
	_position(Vector2(position.x * global::SPRITE_RATIO, position.y * global::SPRITE_RATIO))
{}

void Tile::update(int elapsedTime) {}

void Tile::draw(Graphics &graphics) {
	SDL_Rect destRect = { this->_position.x, this->_position.y, this->_size.x * global::SPRITE_RATIO, this->_size.y * global::SPRITE_RATIO };
